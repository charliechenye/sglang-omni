...
"""Qwen3-Omni thinker runner with prefill payload support."""
...
class Qwen3OmniThinkerModelRunner(ThinkerModelRunner):
    """Thinker runner with Qwen3-Omni's prefill payload path."""
    ...
    def _can_use_prefill_payload(
        ...
        for req in schedule_reqs:
            ...
            # the legacy eager path until they have their own payload
