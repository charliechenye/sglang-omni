...
class ModelCapabilities:
    ...
    - supports_breakable_prefill_cuda_graph: the architecture satisfies the breakable
      prefill CUDA graph contract (discoverable decoder, OmniPrefillInputs
      payload, eager-tail-safe head); enabling it per deployment stays with
      the engine builder policy.
    """
